% Implementation of "A computer aided low-dose CT image denoising using a weighted sparse coding 
% framework via transform filtering for clinical analysis
close all
clear;
Original_image_dir  = 'inputimages/'; % put input images in this folder
...
for nSig = [15 25 35 50 75]
    ...
    for i = 1:im_num
        ...
        % calculate the SSIM & PSNR
        Par.PSNR(Par.outerIter, Par.image)  =   csnr( TFout*255, Par.I*255, 0, 0 );
        Par.SSIM(Par.outerIter, Par.image)      =  cal_ssim( TFout*255, Par.I*255, 0, 0 );
